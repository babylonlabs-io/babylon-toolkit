...
import { Logo } from "@services/simple-staking/src/ui/common/components/Logo/Logo";

const iconLinks = [
    { name: "Website", url: "https://babylonlabs.io", Icon: GoHome },
    { name: "X", url: "https://x.com/babylonlabs_io", Icon: FaXTwitter },
    { name: "GitHub", url: "https://github.com/babylonlabs-io", Icon: BsGithub },
    { name: "Telegram", url: "https://t.me/babyloncommunity", Icon: BsTelegram },
    { name: "LinkedIn", url: "https://www.linkedin.com/company/babylon-labs-official", Icon: BsLinkedin },
    { name: "Docs", url: "https://docs.babylonlabs.io/", Icon: IoMdBook },
    { name: "Forum", url: "https://forum.babylon.foundation/", Icon: MdForum },
    { name: "Email", url: "mailto:contact@babylonlabs.io", Icon: MdAlternateEmail },
    { name: "Discord", url: "https://discord.com/invite/babylonglobal", Icon: BsDiscord },
];
