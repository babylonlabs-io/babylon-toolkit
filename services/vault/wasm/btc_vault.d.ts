...
export class WasmPeginTx {
  ...
  constructor(
    ...
    deposit_script_pubkey: string,
    depositor_pubkey: string,
    claimer_pubkey: string,
    challenger_pubkeys: string[],
    pegin_amount: bigint,
    fee: bigint,
    network: string,
  );
...
export interface InitOutput {
  ...
  readonly wasmpeginpayoutconnector_new: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly wasmpeginpayoutconnector_getAddress: (
    a: number,
    b: number,
    c: number,
  ) => [number, number, number, number];
  readonly wasmpeginpayoutconnector_getScriptPubKey: (
    a: number,
    b: number,
    c: number,
  ) => [number, number, number, number];
  readonly wasmpeginpayoutconnector_getPayoutScript: (
    a: number,
  ) => [number, number];
  readonly wasmpeginpayoutconnector_getTaprootScriptHash: (
    a: number,
  ) => [number, number];
