...
const WasmPeginPayoutConnectorFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmpeginpayoutconnector_free(ptr >>> 0, 1),
      );
...
export class WasmPeginPayoutConnector {
  ...
  constructor(depositor, vault_provider, liquidators) {
    ...
    const ret = wasm.wasmpeginpayoutconnector_new(
      ptr0,
      len0,
      ptr1,
      len1,
  ...
  getAddress(network) {
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      const ret = wasm.wasmpeginpayoutconnector_getAddress(
        this.__wbg_ptr,
        ptr0,
        len0,
      );
  ...
  getScriptPubKey(network) {
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      const ret = wasm.wasmpeginpayoutconnector_getScriptPubKey(
        this.__wbg_ptr,
        ptr0,
        len0,
      );
  ...
  getTaprootScriptHash() {
    ...
    let deferred1_1;
    try {
      const ret = wasm.wasmpeginpayoutconnector_getTaprootScriptHash(
        this.__wbg_ptr,
      );
      deferred1_0 = ret[0];
      deferred1_1 = ret[1];
...
if (Symbol.dispose)
  WasmPeginPayoutConnector.prototype[Symbol.dispose] =
    WasmPeginPayoutConnector.prototype.free;

const WasmPeginTxFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_wasmpegintx_free(ptr >>> 0, 1),
      );
...
export class WasmPeginTx {
  ...
  constructor(
    ...
    const ptr4 = passArrayJsValueToWasm0(
      challenger_pubkeys,
      wasm.__wbindgen_malloc,
    );
    ...
    const ret = wasm.wasmpegintx_new(
      ptr0,
      len0,
      deposit_vout,
      deposit_value,
...
if (Symbol.dispose)
  WasmPeginTx.prototype[Symbol.dispose] = WasmPeginTx.prototype.free;
