...
describe('Deposit Transformers', () => {
  ...
  describe('transformStatusToLabel', () => {
    it('should map contract status to correct label', () => {
      ...
      expect(transformStatusToLabel(ContractStatus.AVAILABLE)).toBe('Available');
  ...
  describe('transformErrorMessage', () => {
    ...
    it('should handle unknown error types', () => {
      ...
      expect(transformErrorMessage(undefined)).toBe('An unexpected error occurred');
  ...
  describe('transformDepositToActivity', () => {
    it('should transform deposit transaction to activity format', () => {
      ...
      expect(activity.pendingMessage).toBe('Waiting for provider acknowledgments');
    });
  });
});
