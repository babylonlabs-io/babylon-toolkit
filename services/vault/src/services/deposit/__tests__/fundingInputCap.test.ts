...
describe("capFundingUtxos", () => {
  ...
  it("drops a malformed high-value UTXO so a valid one keeps the capped slot", () => {
    const utxos: TestUtxo[] = [
      { id: "malformed", value: 999_000, scriptPubKey: MALFORMED_SCRIPT },
      ...makeUtxos(21),
    ];
  ...
  it("returns an empty array when every UTXO script is malformed", () => {
    const utxos: TestUtxo[] = [
      { id: "a", value: 5_000, scriptPubKey: MALFORMED_SCRIPT },
