 ...
 *   sentence-leading.
 * - "BTCVault" (one word) when naming the product or a depositor's vault;
 *   use "BTCVaults" as the plural and never bare "vault". The "vault provider" /
...
const WALLET_NOT_ELIGIBLE_TITLE = "Wallet not eligible";
...
export const COPY = {
  ...
  deposit: {
    ...
    errors: {
      ...
      activationFailed: "Failed to activate BTCVault",
  ...
  wallet: {
    ...
    walletNotEligibleTooltip: WALLET_NOT_ELIGIBLE_TITLE,
    liveness: {
  ...
  addressScreening: {
    title: WALLET_NOT_ELIGIBLE_TITLE,
    body: "This wallet is not eligible to use the BTCVault. Please review the Terms of Use or contact support if you believe this is an error.",
  },
  geoBlock: {
  ...
  reorder: {
    modalTitle: "Reorder BTCVaults",
    modalSubtitle:
      "BTCVault order determines which collateral is liquidated first. Drag to change the liquidation priority.",
    infoText:
      "BTCVaults are liquidated in order from first to last. Place your smallest BTCVault first so it acts as a sacrificial buffer. If your largest BTCVault is first, it will be seized before smaller ones, resulting in a greater loss.",
  ...
  positionNotifications: {
    optimalTitle: "Position optimally structured",
    optimalDetail:
      "BTCVault ordering is correct and partial liquidation is enabled.",
    stalePriceTitle: "Position notifications temporarily unavailable",
    stalePriceDetail:
  ...
  protocolFees: {
    ...
    minForSplit: {
      ...
      tooltip:
        "The minimum amount of BTC required to enable partial liquidation by splitting a deposit into two BTCVaults.",
    },
    ltv: {
  ...
  liquidationWarnings: {
    ...
    cliff: {
      ...
      addSacrificialSuggestion: (sacrificialBtc: string) =>
        `Adding a sacrificial ${sacrificialBtc} BTCVault creates a buffer — it gets liquidated first, your existing BTC survives.`,
      ...
      withdrawResplitSuggestion: (
        ...
        `To enable partial liquidation, withdraw your ${withdrawBtc} BTC and re-deposit as two smaller BTCVaults: ${sacrificialBtc} BTC sacrificial + ${protectedBtc} BTC protected. Alternatively: add collateral or repay debt to manage the liquidation.`,
      ...
      twoVault: {
        ...
        suggestion: (targetSeizureBtc: string, enablePartialStr: string) =>
          `Neither BTCVault alone covers the target seizure (${targetSeizureBtc} BTC). ${enablePartialStr}You can also add collateral or repay part of the debt to keep this position safe. Alternatively: repay the loan, split BTC into optimal UTXOs, and re-open with a sacrificial BTCVault.`,
      },
      multiVault: {
        suggestion: (
          nVaults: number,
