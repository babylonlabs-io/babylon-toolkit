    ...
    tour: {
      ...
      steps: [
        ...
        },
        {
          ...
          body: "Each liquidation event represents a possible liquidation scenario for BTCVaults in your collateral. Events are triggered based on your vault order and BTC price.",
        },
        {
