 ...
 * floor lifts on the next render that re-derives the step — a reload, an
 * unrelated re-render, or a poll tick while another deposit is still
 * progressing — not on a timer of its own.
