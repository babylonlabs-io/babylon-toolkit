  ...
  const handleSign = useCallback(async () => {
    ...
    try {
      ...
      if (canBatchSign) {
        ...
        console.log(
          "[PayoutSigning] Using sequential signing for",
          preparedTransactions.length,
          "transaction pairs",
        );
