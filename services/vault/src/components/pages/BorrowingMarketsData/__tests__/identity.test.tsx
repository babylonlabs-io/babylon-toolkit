...
vi.mock("@/services/token/tokenService", () => ({
  ...
  // No registry entry for this fixture's underlying.
...
describe("BorrowingMarketsData", () => {
  ...
  it("shows the outdated-link state for a symbol URL without resolving any reserve", () => {
