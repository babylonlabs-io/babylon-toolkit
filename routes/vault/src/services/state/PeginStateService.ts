/**
 * Peg-In State Service
 *
 * Centralized state management for peg-in flow.
 * Defines all peg-in states, transitions, and available actions.
 * 
 ...
 * - User actions
 *
 * Based on BTCVaultsManager.sol and vault peg-in flow
 */
 ...
 * Only includes ACTUAL user actions, not waiting states
 */
...
/**
 * Map old PeginStatus enum to new ContractStatus
 * For backward compatibility during migration
 */
export function mapLegacyStatusToContractStatus(
  legacyStatus: string,
): ContractStatus {
  switch (legacyStatus) {
