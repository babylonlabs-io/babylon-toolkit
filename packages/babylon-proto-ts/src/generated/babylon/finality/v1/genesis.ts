  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      indexedBlocks: globalThis.Array.isArray(object?.indexedBlocks)
        ...
        : globalThis.Array.isArray(object?.indexed_blocks)
        ? object.indexed_blocks.map((e: any) => IndexedBlock.fromJSON(e))
        : [],
      ...
      voteSigs: globalThis.Array.isArray(object?.voteSigs)
        ...
        : globalThis.Array.isArray(object?.vote_sigs)
        ? object.vote_sigs.map((e: any) => VoteSig.fromJSON(e))
        : [],
      publicRandomness: globalThis.Array.isArray(object?.publicRandomness)
        ...
        : globalThis.Array.isArray(object?.public_randomness)
        ? object.public_randomness.map((e: any) => PublicRandomness.fromJSON(e))
        : [],
      pubRandCommit: globalThis.Array.isArray(object?.pubRandCommit)
        ? object.pubRandCommit.map((e: any) => PubRandCommitWithPK.fromJSON(e))
        : globalThis.Array.isArray(object?.pub_rand_commit)
        ? object.pub_rand_commit.map((e: any) => PubRandCommitWithPK.fromJSON(e))
        : [],
      ...
      missedBlocks: globalThis.Array.isArray(object?.missedBlocks)
        ...
        ? object.missed_blocks.map((e: any) => FinalityProviderMissedBlocks.fromJSON(e))
        : [],
      votingPowers: globalThis.Array.isArray(object?.votingPowers)
        ? object.votingPowers.map((e: any) => VotingPowerFP.fromJSON(e))
        : globalThis.Array.isArray(object?.voting_powers)
        ? object.voting_powers.map((e: any) => VotingPowerFP.fromJSON(e))
        : [],
      vpDstCache: globalThis.Array.isArray(object?.vpDstCache)
        ...
        : globalThis.Array.isArray(object?.vp_dst_cache)
        ? object.vp_dst_cache.map((e: any) => VotingPowerDistCacheBlkHeight.fromJSON(e))
        : [],
      nextHeightToFinalize: isSet(object.nextHeightToFinalize)
        ? globalThis.Number(object.nextHeightToFinalize)
        : isSet(object.next_height_to_finalize)
        ? globalThis.Number(object.next_height_to_finalize)
        : 0,
      nextHeightToReward: isSet(object.nextHeightToReward)
        ? globalThis.Number(object.nextHeightToReward)
        : isSet(object.next_height_to_reward)
        ? globalThis.Number(object.next_height_to_reward)
        : 0,
      pubRandCommitIndexes: globalThis.Array.isArray(object?.pubRandCommitIndexes)
        ...
        : globalThis.Array.isArray(object?.pub_rand_commit_indexes)
        ? object.pub_rand_commit_indexes.map((e: any) => PubRandCommitIdx.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): VoteSig {
    return {
      ...
      finalitySig: isSet(object.finalitySig)
        ...
        : isSet(object.finality_sig)
        ? bytesFromBase64(object.finality_sig)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): PubRandCommitWithPK {
    return {
      ...
      pubRandCommit: isSet(object.pubRandCommit)
        ...
        : isSet(object.pub_rand_commit)
        ? PubRandCommit.fromJSON(object.pub_rand_commit)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): SigningInfo {
    return {
      ...
      fpSigningInfo: isSet(object.fpSigningInfo)
        ...
        : isSet(object.fp_signing_info)
        ? FinalityProviderSigningInfo.fromJSON(object.fp_signing_info)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): VotingPowerDistCacheBlkHeight {
    return {
      ...
      vpDistribution: isSet(object.vpDistribution)
        ...
        : isSet(object.vp_distribution)
        ? VotingPowerDistCache.fromJSON(object.vp_distribution)
        : undefined,
    };
  },
