  ...
  fromJSON(object: any): QueryActiveFinalityProvidersAtHeightResponse {
    return {
      finalityProviders: globalThis.Array.isArray(object?.finalityProviders)
        ...
        ? object.finality_providers.map((e: any) => ActiveFinalityProvidersAtHeightResponse.fromJSON(e))
        : [],
...
export const QueryListPublicRandomnessResponse: MessageFns<QueryListPublicRandomnessResponse> = {
  encode(message: QueryListPublicRandomnessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.pubRandMap).forEach(([key, value]: [string, Uint8Array]) => {
  ...
  fromJSON(object: any): QueryListPublicRandomnessResponse {
    return {
      pubRandMap: isObject(object.pubRandMap)
        ? (globalThis.Object.entries(object.pubRandMap) as [string, any][]).reduce(
        ...
        : isObject(object.pub_rand_map)
        ? (globalThis.Object.entries(object.pub_rand_map) as [string, any][]).reduce(
          (acc: { [key: number]: Uint8Array }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = bytesFromBase64(value as string);
            return acc;
          },
  ...
  toJSON(message: QueryListPublicRandomnessResponse): unknown {
    ...
    if (message.pubRandMap) {
      const entries = globalThis.Object.entries(message.pubRandMap) as [string, Uint8Array][];
      if (entries.length > 0) {
        obj.pubRandMap = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryListPublicRandomnessResponse>, I>>(
    ...
    const message = createBaseQueryListPublicRandomnessResponse();
    message.pubRandMap = (globalThis.Object.entries(object.pubRandMap ?? {}) as [string, Uint8Array][]).reduce(
  ...
  fromJSON(object: any): PubRandCommitResponse {
    return {
      numPubRand: isSet(object.numPubRand)
        ...
        : isSet(object.num_pub_rand)
        ? globalThis.Number(object.num_pub_rand)
        : 0,
      ...
      epochNum: isSet(object.epochNum)
        ...
        : isSet(object.epoch_num)
        ? globalThis.Number(object.epoch_num)
        : 0,
    };
  },
...
export const QueryListPubRandCommitResponse: MessageFns<QueryListPubRandCommitResponse> = {
  encode(message: QueryListPubRandCommitResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.pubRandCommitMap).forEach(([key, value]: [string, PubRandCommitResponse]) => {
  ...
  fromJSON(object: any): QueryListPubRandCommitResponse {
    return {
      pubRandCommitMap: isObject(object.pubRandCommitMap)
        ? (globalThis.Object.entries(object.pubRandCommitMap) as [string, any][]).reduce(
          (acc: { [key: number]: PubRandCommitResponse }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = PubRandCommitResponse.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.pub_rand_commit_map)
        ? (globalThis.Object.entries(object.pub_rand_commit_map) as [string, any][]).reduce(
          (acc: { [key: number]: PubRandCommitResponse }, [key, value]: [string, any]) => {
            acc[globalThis.Number(key)] = PubRandCommitResponse.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: QueryListPubRandCommitResponse): unknown {
    ...
    if (message.pubRandCommitMap) {
      const entries = globalThis.Object.entries(message.pubRandCommitMap) as [string, PubRandCommitResponse][];
      if (entries.length > 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryListPubRandCommitResponse>, I>>(
    ...
    const message = createBaseQueryListPubRandCommitResponse();
    message.pubRandCommitMap =
      (globalThis.Object.entries(object.pubRandCommitMap ?? {}) as [string, PubRandCommitResponse][]).reduce(
        (acc: { [key: number]: PubRandCommitResponse }, [key, value]: [string, PubRandCommitResponse]) => {
          if (value !== undefined) {
  ...
  fromJSON(object: any): QueryVotesAtHeightResponse {
    return {
      btcPks: globalThis.Array.isArray(object?.btcPks)
        ...
        : globalThis.Array.isArray(object?.btc_pks)
        ? object.btc_pks.map((e: any) => bytesFromBase64(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): EvidenceResponse {
    return {
      ...
      pubRand: isSet(object.pubRand)
        ...
        : isSet(object.pub_rand)
        ? bytesFromBase64(object.pub_rand)
        : new Uint8Array(0),
      canonicalAppHash: isSet(object.canonicalAppHash)
        ? bytesFromBase64(object.canonicalAppHash)
        : isSet(object.canonical_app_hash)
        ? bytesFromBase64(object.canonical_app_hash)
        : new Uint8Array(0),
      forkAppHash: isSet(object.forkAppHash)
        ? bytesFromBase64(object.forkAppHash)
        : isSet(object.fork_app_hash)
        ? bytesFromBase64(object.fork_app_hash)
        : new Uint8Array(0),
      canonicalFinalitySig: isSet(object.canonicalFinalitySig)
        ? bytesFromBase64(object.canonicalFinalitySig)
        : isSet(object.canonical_finality_sig)
        ? bytesFromBase64(object.canonical_finality_sig)
        : new Uint8Array(0),
      forkFinalitySig: isSet(object.forkFinalitySig)
        ? bytesFromBase64(object.forkFinalitySig)
        : isSet(object.fork_finality_sig)
        ? bytesFromBase64(object.fork_finality_sig)
        : new Uint8Array(0),
      signingContext: isSet(object.signingContext)
        ? globalThis.String(object.signingContext)
        : isSet(object.signing_context)
        ? globalThis.String(object.signing_context)
        : "",
    };
  },
  ...
  fromJSON(object: any): QuerySigningInfoResponse {
    return {
      signingInfo: isSet(object.signingInfo)
        ...
        : isSet(object.signing_info)
        ? SigningInfoResponse.fromJSON(object.signing_info)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): QuerySigningInfosResponse {
    return {
      signingInfos: globalThis.Array.isArray(object?.signingInfos)
        ...
        ? object.signing_infos.map((e: any) => SigningInfoResponse.fromJSON(e))
        : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
