  ...
  fromJSON(object: any): MsgAddFinalitySig {
    return {
      ...
      blockAppHash: isSet(object.blockAppHash)
        ...
        : isSet(object.block_app_hash)
        ? bytesFromBase64(object.block_app_hash)
        : new Uint8Array(0),
  ...
  fromJSON(object: any): MsgEquivocationEvidence {
    return {
      ...
      blockHeight: isSet(object.blockHeight)
        ...
        ? globalThis.Number(object.block_height)
        : 0,
      pubRandHex: isSet(object.pubRandHex)
        ? globalThis.String(object.pubRandHex)
        : isSet(object.pub_rand_hex)
        ? globalThis.String(object.pub_rand_hex)
        : "",
      canonicalAppHashHex: isSet(object.canonicalAppHashHex)
        ? globalThis.String(object.canonicalAppHashHex)
        : isSet(object.canonical_app_hash_hex)
        ? globalThis.String(object.canonical_app_hash_hex)
        : "",
      forkAppHashHex: isSet(object.forkAppHashHex)
        ? globalThis.String(object.forkAppHashHex)
        : isSet(object.fork_app_hash_hex)
        ? globalThis.String(object.fork_app_hash_hex)
        : "",
      canonicalFinalitySigHex: isSet(object.canonicalFinalitySigHex)
        ? globalThis.String(object.canonicalFinalitySigHex)
        : isSet(object.canonical_finality_sig_hex)
        ? globalThis.String(object.canonical_finality_sig_hex)
        : "",
      forkFinalitySigHex: isSet(object.forkFinalitySigHex)
        ? globalThis.String(object.forkFinalitySigHex)
        : isSet(object.fork_finality_sig_hex)
        ? globalThis.String(object.fork_finality_sig_hex)
        : "",
...
export const MsgResumeFinalityProposal: MessageFns<MsgResumeFinalityProposal> = {
  ...
  fromJSON(object: any): MsgResumeFinalityProposal {
    return {
      authority: isSet(object.authority) ? globalThis.String(object.authority) : "",
      fpPksHex: globalThis.Array.isArray(object?.fpPksHex)
        ? object.fpPksHex.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.fp_pks_hex)
        ? object.fp_pks_hex.map((e: any) => globalThis.String(e))
        : [],
      haltingHeight: isSet(object.haltingHeight)
        ? globalThis.Number(object.haltingHeight)
        : isSet(object.halting_height)
        ? globalThis.Number(object.halting_height)
        : 0,
    };
  },
