  ...
  fromJSON(object: any): IndexedHeader {
    return {
      ...
      babylonHeaderHash: isSet(object.babylonHeaderHash)
        ...
        : isSet(object.babylon_header_hash)
        ? bytesFromBase64(object.babylon_header_hash)
        : new Uint8Array(0),
      babylonHeaderHeight: isSet(object.babylonHeaderHeight)
        ? globalThis.Number(object.babylonHeaderHeight)
        : isSet(object.babylon_header_height)
        ? globalThis.Number(object.babylon_header_height)
        : 0,
      babylonEpoch: isSet(object.babylonEpoch)
        ? globalThis.Number(object.babylonEpoch)
        : isSet(object.babylon_epoch)
        ? globalThis.Number(object.babylon_epoch)
        : 0,
      babylonTxHash: isSet(object.babylonTxHash)
        ? bytesFromBase64(object.babylonTxHash)
        : isSet(object.babylon_tx_hash)
        ? bytesFromBase64(object.babylon_tx_hash)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): ChainInfo {
    return {
      ...
      latestHeader: isSet(object.latestHeader)
        ...
        : isSet(object.latest_header)
        ? IndexedHeader.fromJSON(object.latest_header)
        : undefined,
      timestampedHeadersCount: isSet(object.timestampedHeadersCount)
        ? globalThis.Number(object.timestampedHeadersCount)
        : isSet(object.timestamped_headers_count)
        ? globalThis.Number(object.timestamped_headers_count)
        : 0,
    };
  },
  ...
  fromJSON(object: any): ChainInfoWithProof {
    return {
      chainInfo: isSet(object.chainInfo)
        ...
        : isSet(object.chain_info)
        ? ChainInfo.fromJSON(object.chain_info)
        : undefined,
      proofHeaderInEpoch: isSet(object.proofHeaderInEpoch)
        ? ProofOps.fromJSON(object.proofHeaderInEpoch)
        : isSet(object.proof_header_in_epoch)
        ? ProofOps.fromJSON(object.proof_header_in_epoch)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): FinalizedChainInfo {
    return {
      ...
      finalizedChainInfo: isSet(object.finalizedChainInfo)
        ...
        : isSet(object.finalized_chain_info)
        ? ChainInfo.fromJSON(object.finalized_chain_info)
        : undefined,
      epochInfo: isSet(object.epochInfo)
        ? Epoch.fromJSON(object.epochInfo)
        : isSet(object.epoch_info)
        ? Epoch.fromJSON(object.epoch_info)
        : undefined,
      rawCheckpoint: isSet(object.rawCheckpoint)
        ? RawCheckpoint.fromJSON(object.rawCheckpoint)
        : isSet(object.raw_checkpoint)
        ? RawCheckpoint.fromJSON(object.raw_checkpoint)
        : undefined,
      btcSubmissionKey: isSet(object.btcSubmissionKey)
        ? SubmissionKey.fromJSON(object.btcSubmissionKey)
        : isSet(object.btc_submission_key)
        ? SubmissionKey.fromJSON(object.btc_submission_key)
        : undefined,
  ...
  fromJSON(object: any): ProofEpochSealed {
    return {
      validatorSet: globalThis.Array.isArray(object?.validatorSet)
        ...
        ? object.validator_set.map((e: any) => ValidatorWithBlsKey.fromJSON(e))
        : [],
      proofEpochInfo: isSet(object.proofEpochInfo)
        ? ProofOps.fromJSON(object.proofEpochInfo)
        : isSet(object.proof_epoch_info)
        ? ProofOps.fromJSON(object.proof_epoch_info)
        : undefined,
      proofEpochValSet: isSet(object.proofEpochValSet)
        ? ProofOps.fromJSON(object.proofEpochValSet)
        : isSet(object.proof_epoch_val_set)
        ? ProofOps.fromJSON(object.proof_epoch_val_set)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): ProofFinalizedChainInfo {
    return {
      proofConsumerHeaderInEpoch: isSet(object.proofConsumerHeaderInEpoch)
        ...
        : isSet(object.proof_consumer_header_in_epoch)
        ? ProofOps.fromJSON(object.proof_consumer_header_in_epoch)
        : undefined,
      proofEpochSealed: isSet(object.proofEpochSealed)
        ? ProofEpochSealed.fromJSON(object.proofEpochSealed)
        : isSet(object.proof_epoch_sealed)
        ? ProofEpochSealed.fromJSON(object.proof_epoch_sealed)
        : undefined,
      proofEpochSubmitted: globalThis.Array.isArray(object?.proofEpochSubmitted)
        ...
        : globalThis.Array.isArray(object?.proof_epoch_submitted)
        ? object.proof_epoch_submitted.map((e: any) => TransactionInfo.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): BTCChainSegment {
    return {
      btcHeaders: globalThis.Array.isArray(object?.btcHeaders)
        ...
        : globalThis.Array.isArray(object?.btc_headers)
        ? object.btc_headers.map((e: any) => BTCHeaderInfo.fromJSON(e))
        : [],
    };
  },
...
export const ConsumerBTCState: MessageFns<ConsumerBTCState> = {
  ...
  fromJSON(object: any): ConsumerBTCState {
    return {
      baseHeader: isSet(object.baseHeader)
        ? BTCHeaderInfo.fromJSON(object.baseHeader)
        : isSet(object.base_header)
        ? BTCHeaderInfo.fromJSON(object.base_header)
        : undefined,
      lastSentSegment: isSet(object.lastSentSegment)
        ? BTCChainSegment.fromJSON(object.lastSentSegment)
        : isSet(object.last_sent_segment)
        ? BTCChainSegment.fromJSON(object.last_sent_segment)
        : undefined,
    };
  },
