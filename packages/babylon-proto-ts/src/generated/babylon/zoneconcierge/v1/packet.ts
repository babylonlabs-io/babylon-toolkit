  ...
  fromJSON(object: any): OutboundPacket {
    return {
      btcTimestamp: isSet(object.btcTimestamp)
        ...
        : isSet(object.btc_timestamp)
        ? BTCTimestamp.fromJSON(object.btc_timestamp)
        : undefined,
      btcStaking: isSet(object.btcStaking)
        ? BTCStakingIBCPacket.fromJSON(object.btcStaking)
        : isSet(object.btc_staking)
        ? BTCStakingIBCPacket.fromJSON(object.btc_staking)
        : undefined,
      btcHeaders: isSet(object.btcHeaders)
        ? BTCHeaders.fromJSON(object.btcHeaders)
        : isSet(object.btc_headers)
        ? BTCHeaders.fromJSON(object.btc_headers)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): InboundPacket {
    return {
      consumerSlashing: isSet(object.consumerSlashing)
        ...
        : isSet(object.consumer_slashing)
        ? ConsumerSlashingIBCPacket.fromJSON(object.consumer_slashing)
        : undefined,
      bsnBaseBtcHeader: isSet(object.bsnBaseBtcHeader)
        ? BSNBaseBTCHeaderIBCPacket.fromJSON(object.bsnBaseBtcHeader)
        : isSet(object.bsn_base_btc_header)
        ? BSNBaseBTCHeaderIBCPacket.fromJSON(object.bsn_base_btc_header)
        : undefined,
    };
  },
...
export const BSNBaseBTCHeaderIBCPacket: MessageFns<BSNBaseBTCHeaderIBCPacket> = {
  ...
  fromJSON(object: any): BSNBaseBTCHeaderIBCPacket {
    return {
      baseBtcHeader: isSet(object.baseBtcHeader)
        ? BTCHeaderInfo.fromJSON(object.baseBtcHeader)
        : isSet(object.base_btc_header)
        ? BTCHeaderInfo.fromJSON(object.base_btc_header)
        : undefined,
    };
  },
