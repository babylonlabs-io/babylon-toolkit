  ...
  fromJSON(object: any): Params {
    return {
      covenantPks: globalThis.Array.isArray(object?.covenantPks)
        ...
        : globalThis.Array.isArray(object?.covenant_pks)
        ? object.covenant_pks.map((e: any) => bytesFromBase64(e))
        : [],
      covenantQuorum: isSet(object.covenantQuorum)
        ? globalThis.Number(object.covenantQuorum)
        : isSet(object.covenant_quorum)
        ? globalThis.Number(object.covenant_quorum)
        : 0,
      minStakingValueSat: isSet(object.minStakingValueSat)
        ? globalThis.Number(object.minStakingValueSat)
        : isSet(object.min_staking_value_sat)
        ? globalThis.Number(object.min_staking_value_sat)
        : 0,
      maxStakingValueSat: isSet(object.maxStakingValueSat)
        ? globalThis.Number(object.maxStakingValueSat)
        : isSet(object.max_staking_value_sat)
        ? globalThis.Number(object.max_staking_value_sat)
        : 0,
      minStakingTimeBlocks: isSet(object.minStakingTimeBlocks)
        ? globalThis.Number(object.minStakingTimeBlocks)
        : isSet(object.min_staking_time_blocks)
        ? globalThis.Number(object.min_staking_time_blocks)
        : 0,
      maxStakingTimeBlocks: isSet(object.maxStakingTimeBlocks)
        ? globalThis.Number(object.maxStakingTimeBlocks)
        : isSet(object.max_staking_time_blocks)
        ? globalThis.Number(object.max_staking_time_blocks)
        : 0,
      slashingPkScript: isSet(object.slashingPkScript)
        ? bytesFromBase64(object.slashingPkScript)
        : isSet(object.slashing_pk_script)
        ? bytesFromBase64(object.slashing_pk_script)
        : new Uint8Array(0),
      minSlashingTxFeeSat: isSet(object.minSlashingTxFeeSat)
        ? globalThis.Number(object.minSlashingTxFeeSat)
        : isSet(object.min_slashing_tx_fee_sat)
        ? globalThis.Number(object.min_slashing_tx_fee_sat)
        : 0,
      slashingRate: isSet(object.slashingRate)
        ? globalThis.String(object.slashingRate)
        : isSet(object.slashing_rate)
        ? globalThis.String(object.slashing_rate)
        : "",
      unbondingTimeBlocks: isSet(object.unbondingTimeBlocks)
        ? globalThis.Number(object.unbondingTimeBlocks)
        : isSet(object.unbonding_time_blocks)
        ? globalThis.Number(object.unbonding_time_blocks)
        : 0,
      unbondingFeeSat: isSet(object.unbondingFeeSat)
        ? globalThis.Number(object.unbondingFeeSat)
        : isSet(object.unbonding_fee_sat)
        ? globalThis.Number(object.unbonding_fee_sat)
        : 0,
      ...
      delegationCreationBaseGasFee: isSet(object.delegationCreationBaseGasFee)
        ...
        : isSet(object.delegation_creation_base_gas_fee)
        ? globalThis.Number(object.delegation_creation_base_gas_fee)
        : 0,
      allowListExpirationHeight: isSet(object.allowListExpirationHeight)
        ? globalThis.Number(object.allowListExpirationHeight)
        : isSet(object.allow_list_expiration_height)
        ? globalThis.Number(object.allow_list_expiration_height)
        : 0,
      btcActivationHeight: isSet(object.btcActivationHeight)
        ? globalThis.Number(object.btcActivationHeight)
        : isSet(object.btc_activation_height)
        ? globalThis.Number(object.btc_activation_height)
        : 0,
      maxFinalityProviders: isSet(object.maxFinalityProviders)
        ? globalThis.Number(object.maxFinalityProviders)
        : isSet(object.max_finality_providers)
        ? globalThis.Number(object.max_finality_providers)
        : 0,
    };
  },
