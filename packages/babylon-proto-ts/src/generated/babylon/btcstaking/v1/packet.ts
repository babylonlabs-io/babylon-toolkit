  ...
  fromJSON(object: any): SlashedFinalityProvider {
    return {
      ...
      recoveredFpBtcSk: isSet(object.recoveredFpBtcSk)
        ? globalThis.String(object.recoveredFpBtcSk)
        : isSet(object.recovered_fp_btc_sk)
        ? globalThis.String(object.recovered_fp_btc_sk)
        : "",
    };
  },
  ...
  fromJSON(object: any): BTCStakingIBCPacket {
    return {
      newFp: globalThis.Array.isArray(object?.newFp)
        ...
        : globalThis.Array.isArray(object?.new_fp)
        ? object.new_fp.map((e: any) => NewFinalityProvider.fromJSON(e))
        : [],
      activeDel: globalThis.Array.isArray(object?.activeDel)
        ? object.activeDel.map((e: any) => ActiveBTCDelegation.fromJSON(e))
        : globalThis.Array.isArray(object?.active_del)
        ? object.active_del.map((e: any) => ActiveBTCDelegation.fromJSON(e))
        : [],
      slashedDel: globalThis.Array.isArray(object?.slashedDel)
        ? object.slashedDel.map((e: any) => SlashedBTCDelegation.fromJSON(e))
        : globalThis.Array.isArray(object?.slashed_del)
        ? object.slashed_del.map((e: any) => SlashedBTCDelegation.fromJSON(e))
        : [],
      unbondedDel: globalThis.Array.isArray(object?.unbondedDel)
        ? object.unbondedDel.map((e: any) => UnbondedBTCDelegation.fromJSON(e))
        : globalThis.Array.isArray(object?.unbonded_del)
        ? object.unbonded_del.map((e: any) => UnbondedBTCDelegation.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): ActiveBTCDelegation {
    return {
      ...
      fpBtcPkList: globalThis.Array.isArray(object?.fpBtcPkList)
        ...
        ? object.fp_btc_pk_list.map((e: any) => globalThis.String(e))
        : [],
      ...
      undelegationInfo: isSet(object.undelegationInfo)
        ...
        : isSet(object.undelegation_info)
        ? BTCUndelegationInfo.fromJSON(object.undelegation_info)
        : undefined,
  ...
  fromJSON(object: any): UnbondedBTCDelegation {
    return {
      ...
      unbondingTxSig: isSet(object.unbondingTxSig)
        ...
        : isSet(object.unbonding_tx_sig)
        ? bytesFromBase64(object.unbonding_tx_sig)
        : new Uint8Array(0),
      stakeSpendingTx: isSet(object.stakeSpendingTx)
        ? bytesFromBase64(object.stakeSpendingTx)
        : isSet(object.stake_spending_tx)
        ? bytesFromBase64(object.stake_spending_tx)
        : new Uint8Array(0),
...
export const BTCStakingConsumerEvent: MessageFns<BTCStakingConsumerEvent> = {
  ...
  fromJSON(object: any): BTCStakingConsumerEvent {
    return {
      newFp: isSet(object.newFp)
        ? NewFinalityProvider.fromJSON(object.newFp)
        : isSet(object.new_fp)
        ? NewFinalityProvider.fromJSON(object.new_fp)
        : undefined,
      activeDel: isSet(object.activeDel)
        ? ActiveBTCDelegation.fromJSON(object.activeDel)
        : isSet(object.active_del)
        ? ActiveBTCDelegation.fromJSON(object.active_del)
        : undefined,
      slashedDel: isSet(object.slashedDel)
        ? SlashedBTCDelegation.fromJSON(object.slashedDel)
        : isSet(object.slashed_del)
        ? SlashedBTCDelegation.fromJSON(object.slashed_del)
        : undefined,
      unbondedDel: isSet(object.unbondedDel)
        ? UnbondedBTCDelegation.fromJSON(object.unbondedDel)
        : isSet(object.unbonded_del)
        ? UnbondedBTCDelegation.fromJSON(object.unbonded_del)
        : undefined,
    };
  },
