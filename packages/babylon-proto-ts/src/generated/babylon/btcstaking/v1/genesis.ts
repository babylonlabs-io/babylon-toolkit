  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      finalityProviders: globalThis.Array.isArray(object?.finalityProviders)
        ...
        ? object.finality_providers.map((e: any) => FinalityProvider.fromJSON(e))
        : [],
      btcDelegations: globalThis.Array.isArray(object?.btcDelegations)
        ...
        ? object.btc_delegations.map((e: any) => BTCDelegation.fromJSON(e))
        : [],
      blockHeightChains: globalThis.Array.isArray(object?.blockHeightChains)
        ...
        : globalThis.Array.isArray(object?.block_height_chains)
        ? object.block_height_chains.map((e: any) => BlockHeightBbnToBtc.fromJSON(e))
        : [],
      btcDelegators: globalThis.Array.isArray(object?.btcDelegators)
        ? object.btcDelegators.map((e: any) => BTCDelegator.fromJSON(e))
        : globalThis.Array.isArray(object?.btc_delegators)
        ? object.btc_delegators.map((e: any) => BTCDelegator.fromJSON(e))
        : [],
      ...
      allowedStakingTxHashes: globalThis.Array.isArray(object?.allowedStakingTxHashes)
        ...
        : globalThis.Array.isArray(object?.allowed_staking_tx_hashes)
        ? object.allowed_staking_tx_hashes.map((e: any) => globalThis.String(e))
        : [],
      largestBtcReorg: isSet(object.largestBtcReorg)
        ? LargestBtcReOrg.fromJSON(object.largestBtcReorg)
        : isSet(object.largest_btc_reorg)
        ? LargestBtcReOrg.fromJSON(object.largest_btc_reorg)
        : undefined,
      consumerEvents: globalThis.Array.isArray(object?.consumerEvents)
        ? object.consumerEvents.map((e: any) => ConsumerEvent.fromJSON(e))
        : globalThis.Array.isArray(object?.consumer_events)
        ? object.consumer_events.map((e: any) => ConsumerEvent.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): BlockHeightBbnToBtc {
    return {
      blockHeightBbn: isSet(object.blockHeightBbn)
        ...
        : isSet(object.block_height_bbn)
        ? globalThis.Number(object.block_height_bbn)
        : 0,
      blockHeightBtc: isSet(object.blockHeightBtc)
        ? globalThis.Number(object.blockHeightBtc)
        : isSet(object.block_height_btc)
        ? globalThis.Number(object.block_height_btc)
        : 0,
    };
  },
  ...
  fromJSON(object: any): BTCDelegator {
    return {
      ...
      delBtcPk: isSet(object.delBtcPk)
        ...
        : isSet(object.del_btc_pk)
        ? bytesFromBase64(object.del_btc_pk)
        : new Uint8Array(0),
    };
  },
