  ...
  fromJSON(object: any): MsgCreateBTCDelegation {
    return {
      ...
      stakingValue: isSet(object.stakingValue)
        ...
        : isSet(object.staking_value)
        ? globalThis.Number(object.staking_value)
        : 0,
      ...
      stakingTxInclusionProof: isSet(object.stakingTxInclusionProof)
        ...
        : isSet(object.staking_tx_inclusion_proof)
        ? InclusionProof.fromJSON(object.staking_tx_inclusion_proof)
        : undefined,
      ...
      unbondingValue: isSet(object.unbondingValue)
        ...
        : isSet(object.unbonding_value)
        ? globalThis.Number(object.unbonding_value)
        : 0,
      unbondingSlashingTx: isSet(object.unbondingSlashingTx)
        ? bytesFromBase64(object.unbondingSlashingTx)
        : isSet(object.unbonding_slashing_tx)
        ? bytesFromBase64(object.unbonding_slashing_tx)
        : new Uint8Array(0),
      delegatorUnbondingSlashingSig: isSet(object.delegatorUnbondingSlashingSig)
        ...
        : isSet(object.delegator_unbonding_slashing_sig)
        ? bytesFromBase64(object.delegator_unbonding_slashing_sig)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): MsgBtcStakeExpand {
    return {
      ...
      previousStakingTxHash: isSet(object.previousStakingTxHash)
        ...
        : "",
      fundingTx: isSet(object.fundingTx)
        ? bytesFromBase64(object.fundingTx)
        : isSet(object.funding_tx)
        ? bytesFromBase64(object.funding_tx)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): MsgAddCovenantSigs {
    return {
      ...
      slashingTxSigs: globalThis.Array.isArray(object?.slashingTxSigs)
        ...
        : globalThis.Array.isArray(object?.slashing_tx_sigs)
        ? object.slashing_tx_sigs.map((e: any) => bytesFromBase64(e))
        : [],
      ...
      slashingUnbondingTxSigs: globalThis.Array.isArray(object?.slashingUnbondingTxSigs)
        ...
        : globalThis.Array.isArray(object?.slashing_unbonding_tx_sigs)
        ? object.slashing_unbonding_tx_sigs.map((e: any) => bytesFromBase64(e))
        : [],
      stakeExpansionTxSig: isSet(object.stakeExpansionTxSig)
        ? bytesFromBase64(object.stakeExpansionTxSig)
        : isSet(object.stake_expansion_tx_sig)
        ? bytesFromBase64(object.stake_expansion_tx_sig)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): MsgBTCUndelegate {
    return {
      ...
      stakeSpendingTxInclusionProof: isSet(object.stakeSpendingTxInclusionProof)
        ...
        : isSet(object.stake_spending_tx_inclusion_proof)
        ? InclusionProof.fromJSON(object.stake_spending_tx_inclusion_proof)
        : undefined,
      fundingTransactions: globalThis.Array.isArray(object?.fundingTransactions)
        ...
        : globalThis.Array.isArray(object?.funding_transactions)
        ? object.funding_transactions.map((e: any) => bytesFromBase64(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): MsgAddBsnRewards {
    return {
      ...
      fpRatios: globalThis.Array.isArray(object?.fpRatios)
        ? object.fpRatios.map((e: any) => FpRatio.fromJSON(e))
        : globalThis.Array.isArray(object?.fp_ratios)
        ? object.fp_ratios.map((e: any) => FpRatio.fromJSON(e))
        : [],
    };
  },
