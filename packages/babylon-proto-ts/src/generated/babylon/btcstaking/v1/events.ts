  ...
  fromJSON(object: any): EventFinalityProviderCreated {
    return {
      btcPkHex: isSet(object.btcPkHex)
        ...
        : isSet(object.btc_pk_hex)
        ? globalThis.String(object.btc_pk_hex)
        : "",
  ...
  fromJSON(object: any): EventBTCDelegationStateUpdate {
    return {
      stakingTxHash: isSet(object.stakingTxHash)
        ...
        : isSet(object.staking_tx_hash)
        ? globalThis.String(object.staking_tx_hash)
        : "",
      newState: isSet(object.newState)
        ? bTCDelegationStatusFromJSON(object.newState)
        : isSet(object.new_state)
        ? bTCDelegationStatusFromJSON(object.new_state)
        : 0,
    };
  },
  ...
  fromJSON(object: any): EventPowerDistUpdate {
    return {
      slashedFp: isSet(object.slashedFp)
        ...
        : isSet(object.slashed_fp)
        ? EventPowerDistUpdate_EventSlashedFinalityProvider.fromJSON(object.slashed_fp)
        : undefined,
      jailedFp: isSet(object.jailedFp)
        ? EventPowerDistUpdate_EventJailedFinalityProvider.fromJSON(object.jailedFp)
        : isSet(object.jailed_fp)
        ? EventPowerDistUpdate_EventJailedFinalityProvider.fromJSON(object.jailed_fp)
        : undefined,
      unjailedFp: isSet(object.unjailedFp)
        ? EventPowerDistUpdate_EventUnjailedFinalityProvider.fromJSON(object.unjailedFp)
        : isSet(object.unjailed_fp)
        ? EventPowerDistUpdate_EventUnjailedFinalityProvider.fromJSON(object.unjailed_fp)
        : undefined,
      btcDelStateUpdate: isSet(object.btcDelStateUpdate)
        ? EventBTCDelegationStateUpdate.fromJSON(object.btcDelStateUpdate)
        : isSet(object.btc_del_state_update)
        ? EventBTCDelegationStateUpdate.fromJSON(object.btc_del_state_update)
        : undefined,
      slashedBtcDelegation: isSet(object.slashedBtcDelegation)
        ...
        : isSet(object.slashed_btc_delegation)
        ? EventPowerDistUpdate_EventSlashedBTCDelegation.fromJSON(object.slashed_btc_delegation)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): EventFinalityProviderStatusChange {
    return {
      btcPk: isSet(object.btcPk)
        ? globalThis.String(object.btcPk)
        : isSet(object.btc_pk)
        ? globalThis.String(object.btc_pk)
        : "",
      newState: isSet(object.newState)
  ...
  fromJSON(object: any): EventBTCDelegationCreated {
    return {
      stakingTxHex: isSet(object.stakingTxHex)
        ...
        : "",
      stakingOutputIndex: isSet(object.stakingOutputIndex)
        ? globalThis.String(object.stakingOutputIndex)
        : isSet(object.staking_output_index)
        ? globalThis.String(object.staking_output_index)
        : "",
      paramsVersion: isSet(object.paramsVersion)
        ? globalThis.String(object.paramsVersion)
        : isSet(object.params_version)
        ? globalThis.String(object.params_version)
        : "",
  ...
  fromJSON(object: any): EventCovenantSignatureReceived {
    return {
      ...
      covenantBtcPkHex: isSet(object.covenantBtcPkHex)
        ...
        : isSet(object.covenant_btc_pk_hex)
        ? globalThis.String(object.covenant_btc_pk_hex)
        : "",
      covenantUnbondingSignatureHex: isSet(object.covenantUnbondingSignatureHex)
        ...
        : isSet(object.covenant_unbonding_signature_hex)
        ? globalThis.String(object.covenant_unbonding_signature_hex)
        : "",
    };
  },
  ...
  fromJSON(object: any): EventBTCDelegationInclusionProofReceived {
    return {
      ...
      endHeight: isSet(object.endHeight)
        ...
        ? globalThis.String(object.end_height)
        : "",
      newState: isSet(object.newState)
        ? globalThis.String(object.newState)
        : isSet(object.new_state)
  ...
  fromJSON(object: any): EventUnexpectedUnbondingTx {
    return {
      stakingTxHash: isSet(object.stakingTxHash)
        ...
        ? globalThis.String(object.staking_tx_hash)
        : "",
      spendStakeTxHash: isSet(object.spendStakeTxHash)
        ? globalThis.String(object.spendStakeTxHash)
        : isSet(object.spend_stake_tx_hash)
        ? globalThis.String(object.spend_stake_tx_hash)
        : "",
      spendStakeTxHeaderHash: isSet(object.spendStakeTxHeaderHash)
        ? globalThis.String(object.spendStakeTxHeaderHash)
        : isSet(object.spend_stake_tx_header_hash)
        ? globalThis.String(object.spend_stake_tx_header_hash)
        : "",
      spendStakeTxBlockIndex: isSet(object.spendStakeTxBlockIndex)
        ? globalThis.Number(object.spendStakeTxBlockIndex)
        : isSet(object.spend_stake_tx_block_index)
        ? globalThis.Number(object.spend_stake_tx_block_index)
        : 0,
    };
  },
  ...
  fromJSON(object: any): EventStakeExpansionActivated {
    return {
      previousStakingTxHash: isSet(object.previousStakingTxHash)
        ? globalThis.String(object.previousStakingTxHash)
        : isSet(object.previous_staking_tx_hash)
        ? globalThis.String(object.previous_staking_tx_hash)
        : "",
      stakeExpansionTxHash: isSet(object.stakeExpansionTxHash)
        ? globalThis.String(object.stakeExpansionTxHash)
        : isSet(object.stake_expansion_tx_hash)
        ? globalThis.String(object.stake_expansion_tx_hash)
        : "",
      stakeExpansionTxHeaderHash: isSet(object.stakeExpansionTxHeaderHash)
        ? globalThis.String(object.stakeExpansionTxHeaderHash)
        : isSet(object.stake_expansion_tx_header_hash)
        ? globalThis.String(object.stake_expansion_tx_header_hash)
        : "",
      stakeExpansionTxBlockIndex: isSet(object.stakeExpansionTxBlockIndex)
        ? globalThis.Number(object.stakeExpansionTxBlockIndex)
        : isSet(object.stake_expansion_tx_block_index)
        ? globalThis.Number(object.stake_expansion_tx_block_index)
        : 0,
    };
  },
...
export const EventAddBsnRewards: MessageFns<EventAddBsnRewards> = {
  ...
  fromJSON(object: any): EventAddBsnRewards {
    return {
      ...
      bsnConsumerId: isSet(object.bsnConsumerId)
        ? globalThis.String(object.bsnConsumerId)
        : isSet(object.bsn_consumer_id)
        ? globalThis.String(object.bsn_consumer_id)
        : "",
      totalRewards: globalThis.Array.isArray(object?.totalRewards)
        ? object.totalRewards.map((e: any) => Coin.fromJSON(e))
        : globalThis.Array.isArray(object?.total_rewards)
      ...
      babylonCommission: globalThis.Array.isArray(object?.babylonCommission)
        ...
        : globalThis.Array.isArray(object?.babylon_commission)
        ? object.babylon_commission.map((e: any) => Coin.fromJSON(e))
        : [],
      fpRatios: globalThis.Array.isArray(object?.fpRatios)
        ? object.fpRatios.map((e: any) => EventFpRewardInfo.fromJSON(e))
        : globalThis.Array.isArray(object?.fp_ratios)
        ? object.fp_ratios.map((e: any) => EventFpRewardInfo.fromJSON(e))
        : [],
    };
  },
