  ...
  fromJSON(object: any): BTCDelegation {
    return {
      ...
      stakingTx: isSet(object.stakingTx)
        ...
        : isSet(object.staking_tx)
        ? bytesFromBase64(object.staking_tx)
        : new Uint8Array(0),
      ...
      slashingTx: isSet(object.slashingTx)
        ...
        : isSet(object.slashing_tx)
        ? bytesFromBase64(object.slashing_tx)
        : new Uint8Array(0),
      delegatorSig: isSet(object.delegatorSig)
        ? bytesFromBase64(object.delegatorSig)
        : isSet(object.delegator_sig)
        ? bytesFromBase64(object.delegator_sig)
        : new Uint8Array(0),
      ...
      btcUndelegation: isSet(object.btcUndelegation)
        ...
        : isSet(object.btc_undelegation)
        ? BTCUndelegation.fromJSON(object.btc_undelegation)
        : undefined,
      ...
      btcTipHeight: isSet(object.btcTipHeight)
        ? globalThis.Number(object.btcTipHeight)
        : isSet(object.btc_tip_height)
        ? globalThis.Number(object.btc_tip_height)
        : 0,
      stkExp: isSet(object.stkExp)
        ? StakeExpansion.fromJSON(object.stkExp)
        : isSet(object.stk_exp)
        ? StakeExpansion.fromJSON(object.stk_exp)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): StakeExpansion {
    return {
      previousStakingTxHash: isSet(object.previousStakingTxHash)
        ...
        ? bytesFromBase64(object.previous_staking_tx_hash)
        : new Uint8Array(0),
      otherFundingTxOut: isSet(object.otherFundingTxOut)
        ? bytesFromBase64(object.otherFundingTxOut)
        : isSet(object.other_funding_tx_out)
        ? bytesFromBase64(object.other_funding_tx_out)
        : new Uint8Array(0),
  ...
  fromJSON(object: any): DelegatorUnbondingInfo {
    return {
      spendStakeTx: isSet(object.spendStakeTx)
        ...
        : isSet(object.spend_stake_tx)
        ? bytesFromBase64(object.spend_stake_tx)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): BTCUndelegation {
    return {
      unbondingTx: isSet(object.unbondingTx)
        ...
        ? bytesFromBase64(object.unbonding_tx)
        : new Uint8Array(0),
      slashingTx: isSet(object.slashingTx)
        ? bytesFromBase64(object.slashingTx)
        : isSet(object.slashing_tx)
      ...
      delegatorSlashingSig: isSet(object.delegatorSlashingSig)
        ...
        : isSet(object.delegator_slashing_sig)
        ? bytesFromBase64(object.delegator_slashing_sig)
        : new Uint8Array(0),
      ...
      delegatorUnbondingInfo: isSet(object.delegatorUnbondingInfo)
        ...
        : isSet(object.delegator_unbonding_info)
        ? DelegatorUnbondingInfo.fromJSON(object.delegator_unbonding_info)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): BTCDelegatorDelegationIndex {
    return {
      stakingTxHashList: globalThis.Array.isArray(object?.stakingTxHashList)
        ...
        : globalThis.Array.isArray(object?.staking_tx_hash_list)
        ? object.staking_tx_hash_list.map((e: any) => bytesFromBase64(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): CovenantAdaptorSignatures {
    return {
      covPk: isSet(object.covPk)
        ...
        : isSet(object.cov_pk)
        ? bytesFromBase64(object.cov_pk)
        : new Uint8Array(0),
      adaptorSigs: globalThis.Array.isArray(object?.adaptorSigs)
        ? object.adaptorSigs.map((e: any) => bytesFromBase64(e))
        : globalThis.Array.isArray(object?.adaptor_sigs)
        ? object.adaptor_sigs.map((e: any) => bytesFromBase64(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): SelectiveSlashingEvidence {
    return {
      ...
      fpBtcPk: isSet(object.fpBtcPk)
        ...
        : isSet(object.fp_btc_pk)
        ? bytesFromBase64(object.fp_btc_pk)
        : new Uint8Array(0),
      recoveredFpBtcSk: isSet(object.recoveredFpBtcSk)
        ? bytesFromBase64(object.recoveredFpBtcSk)
        : isSet(object.recovered_fp_btc_sk)
        ? bytesFromBase64(object.recovered_fp_btc_sk)
        : new Uint8Array(0),
    };
  },
