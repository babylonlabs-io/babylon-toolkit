  ...
  fromJSON(object: any): RewardGaugesResponse {
    return {
      ...
      withdrawnCoins: globalThis.Array.isArray(object?.withdrawnCoins)
        ...
        : globalThis.Array.isArray(object?.withdrawn_coins)
        ? object.withdrawn_coins.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
...
export const QueryRewardGaugesResponse: MessageFns<QueryRewardGaugesResponse> = {
  encode(message: QueryRewardGaugesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.rewardGauges).forEach(([key, value]: [string, RewardGaugesResponse]) => {
  ...
  fromJSON(object: any): QueryRewardGaugesResponse {
    return {
      rewardGauges: isObject(object.rewardGauges)
        ? (globalThis.Object.entries(object.rewardGauges) as [string, any][]).reduce(
          (acc: { [key: string]: RewardGaugesResponse }, [key, value]: [string, any]) => {
            acc[key] = RewardGaugesResponse.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.reward_gauges)
        ? (globalThis.Object.entries(object.reward_gauges) as [string, any][]).reduce(
          (acc: { [key: string]: RewardGaugesResponse }, [key, value]: [string, any]) => {
            acc[key] = RewardGaugesResponse.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: QueryRewardGaugesResponse): unknown {
    ...
    if (message.rewardGauges) {
      const entries = globalThis.Object.entries(message.rewardGauges) as [string, RewardGaugesResponse][];
      if (entries.length > 0) {
        obj.rewardGauges = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryRewardGaugesResponse>, I>>(object: I): QueryRewardGaugesResponse {
    const message = createBaseQueryRewardGaugesResponse();
    message.rewardGauges = (globalThis.Object.entries(object.rewardGauges ?? {}) as [string, RewardGaugesResponse][])
      .reduce((acc: { [key: string]: RewardGaugesResponse }, [key, value]: [string, RewardGaugesResponse]) => {
        if (value !== undefined) {
