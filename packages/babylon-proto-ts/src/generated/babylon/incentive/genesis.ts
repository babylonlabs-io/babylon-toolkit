  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      btcStakingGauges: globalThis.Array.isArray(object?.btcStakingGauges)
        ...
        : globalThis.Array.isArray(object?.btc_staking_gauges)
        ? object.btc_staking_gauges.map((e: any) => BTCStakingGaugeEntry.fromJSON(e))
        : [],
      rewardGauges: globalThis.Array.isArray(object?.rewardGauges)
        ? object.rewardGauges.map((e: any) => RewardGaugeEntry.fromJSON(e))
        : globalThis.Array.isArray(object?.reward_gauges)
        ? object.reward_gauges.map((e: any) => RewardGaugeEntry.fromJSON(e))
        : [],
      withdrawAddresses: globalThis.Array.isArray(object?.withdrawAddresses)
        ...
        : globalThis.Array.isArray(object?.withdraw_addresses)
        ? object.withdraw_addresses.map((e: any) => WithdrawAddressEntry.fromJSON(e))
        : [],
      refundableMsgHashes: globalThis.Array.isArray(object?.refundableMsgHashes)
        ...
        : globalThis.Array.isArray(object?.refundable_msg_hashes)
        ? object.refundable_msg_hashes.map((e: any) => globalThis.String(e))
        : [],
      finalityProvidersCurrentRewards: globalThis.Array.isArray(object?.finalityProvidersCurrentRewards)
        ...
        : globalThis.Array.isArray(object?.finality_providers_current_rewards)
        ? object.finality_providers_current_rewards.map((e: any) => FinalityProviderCurrentRewardsEntry.fromJSON(e))
        : [],
      finalityProvidersHistoricalRewards: globalThis.Array.isArray(object?.finalityProvidersHistoricalRewards)
        ...
        : globalThis.Array.isArray(object?.finality_providers_historical_rewards)
        ? object.finality_providers_historical_rewards.map((e: any) =>
          FinalityProviderHistoricalRewardsEntry.fromJSON(e)
        )
        : [],
      btcDelegationRewardsTrackers: globalThis.Array.isArray(object?.btcDelegationRewardsTrackers)
        ...
        : globalThis.Array.isArray(object?.btc_delegation_rewards_trackers)
        ? object.btc_delegation_rewards_trackers.map((e: any) => BTCDelegationRewardsTrackerEntry.fromJSON(e))
        : [],
      btcDelegatorsToFps: globalThis.Array.isArray(object?.btcDelegatorsToFps)
        ...
        : globalThis.Array.isArray(object?.btc_delegators_to_fps)
        ? object.btc_delegators_to_fps.map((e: any) => BTCDelegatorToFpEntry.fromJSON(e))
        : [],
      eventRewardTracker: globalThis.Array.isArray(object?.eventRewardTracker)
        ...
        : globalThis.Array.isArray(object?.event_reward_tracker)
        ? object.event_reward_tracker.map((e: any) => EventsPowerUpdateAtHeightEntry.fromJSON(e))
        : [],
      lastProcessedHeightEventRewardTracker: isSet(object.lastProcessedHeightEventRewardTracker)
        ...
        : isSet(object.last_processed_height_event_reward_tracker)
        ? globalThis.Number(object.last_processed_height_event_reward_tracker)
        : 0,
    };
  },
...
export const RewardGaugeEntry: MessageFns<RewardGaugeEntry> = {
  ...
  fromJSON(object: any): RewardGaugeEntry {
    return {
      stakeholderType: isSet(object.stakeholderType)
        ? stakeholderTypeFromJSON(object.stakeholderType)
        : isSet(object.stakeholder_type)
        ? stakeholderTypeFromJSON(object.stakeholder_type)
        : 0,
      address: isSet(object.address) ? globalThis.String(object.address) : "",
      rewardGauge: isSet(object.rewardGauge)
        ? RewardGauge.fromJSON(object.rewardGauge)
        : isSet(object.reward_gauge)
        ? RewardGauge.fromJSON(object.reward_gauge)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): BTCDelegationRewardsTrackerEntry {
    return {
      finalityProviderAddress: isSet(object.finalityProviderAddress)
        ...
        : isSet(object.finality_provider_address)
        ? globalThis.String(object.finality_provider_address)
        : "",
      delegatorAddress: isSet(object.delegatorAddress)
        ? globalThis.String(object.delegatorAddress)
        : isSet(object.delegator_address)
