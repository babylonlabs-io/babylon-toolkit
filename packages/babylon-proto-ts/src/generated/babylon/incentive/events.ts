...
export const EventPowerUpdate: MessageFns<EventPowerUpdate> = {
  ...
  fromJSON(object: any): EventPowerUpdate {
    return {
      btcActivated: isSet(object.btcActivated)
        ? EventBTCDelegationActivated.fromJSON(object.btcActivated)
        : isSet(object.btc_activated)
        ? EventBTCDelegationActivated.fromJSON(object.btc_activated)
        : undefined,
      btcUnbonded: isSet(object.btcUnbonded)
        ? EventBTCDelegationUnbonded.fromJSON(object.btcUnbonded)
        : isSet(object.btc_unbonded)
        ? EventBTCDelegationUnbonded.fromJSON(object.btc_unbonded)
        : undefined,
    };
  },
...
export const EventBTCDelegationActivated: MessageFns<EventBTCDelegationActivated> = {
  ...
  fromJSON(object: any): EventBTCDelegationActivated {
    return {
      fpAddr: isSet(object.fpAddr)
        ? globalThis.String(object.fpAddr)
        : isSet(object.fp_addr)
        ? globalThis.String(object.fp_addr)
        : "",
      btcDelAddr: isSet(object.btcDelAddr)
        ? globalThis.String(object.btcDelAddr)
        : isSet(object.btc_del_addr)
        ? globalThis.String(object.btc_del_addr)
        : "",
      totalSat: isSet(object.totalSat)
        ? bytesFromBase64(object.totalSat)
        : isSet(object.total_sat)
        ? bytesFromBase64(object.total_sat)
        : new Uint8Array(0),
    };
  },
