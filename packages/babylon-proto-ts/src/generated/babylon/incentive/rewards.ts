  ...
  fromJSON(object: any): FinalityProviderHistoricalRewards {
    return {
      cumulativeRewardsPerSat: globalThis.Array.isArray(object?.cumulativeRewardsPerSat)
        ...
        : globalThis.Array.isArray(object?.cumulative_rewards_per_sat)
        ? object.cumulative_rewards_per_sat.map((e: any) => Coin.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): FinalityProviderCurrentRewards {
    return {
      currentRewards: globalThis.Array.isArray(object?.currentRewards)
        ...
        : globalThis.Array.isArray(object?.current_rewards)
        ? object.current_rewards.map((e: any) => Coin.fromJSON(e))
        : [],
      period: isSet(object.period) ? globalThis.Number(object.period) : 0,
      totalActiveSat: isSet(object.totalActiveSat)
        ? bytesFromBase64(object.totalActiveSat)
        : isSet(object.total_active_sat)
        ? bytesFromBase64(object.total_active_sat)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): BTCDelegationRewardsTracker {
    return {
      startPeriodCumulativeReward: isSet(object.startPeriodCumulativeReward)
        ...
        : isSet(object.start_period_cumulative_reward)
        ? globalThis.Number(object.start_period_cumulative_reward)
        : 0,
      totalActiveSat: isSet(object.totalActiveSat)
        ? bytesFromBase64(object.totalActiveSat)
        : isSet(object.total_active_sat)
