  ...
  fromJSON(object: any): BTCSpvProof {
    return {
      btcTransaction: isSet(object.btcTransaction)
        ...
        : isSet(object.btc_transaction)
        ? bytesFromBase64(object.btc_transaction)
        : new Uint8Array(0),
      btcTransactionIndex: isSet(object.btcTransactionIndex)
        ? globalThis.Number(object.btcTransactionIndex)
        : isSet(object.btc_transaction_index)
        ? globalThis.Number(object.btc_transaction_index)
        : 0,
      merkleNodes: isSet(object.merkleNodes)
        ? bytesFromBase64(object.merkleNodes)
        : isSet(object.merkle_nodes)
        ? bytesFromBase64(object.merkle_nodes)
        : new Uint8Array(0),
      confirmingBtcHeader: isSet(object.confirmingBtcHeader)
        ? bytesFromBase64(object.confirmingBtcHeader)
        : isSet(object.confirming_btc_header)
        ? bytesFromBase64(object.confirming_btc_header)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): SubmissionData {
    return {
      vigilanteAddresses: isSet(object.vigilanteAddresses)
        ...
        : isSet(object.vigilante_addresses)
        ? CheckpointAddresses.fromJSON(object.vigilante_addresses)
        : undefined,
      txsInfo: globalThis.Array.isArray(object?.txsInfo)
        ? object.txsInfo.map((e: any) => TransactionInfo.fromJSON(e))
        : globalThis.Array.isArray(object?.txs_info)
        ? object.txs_info.map((e: any) => TransactionInfo.fromJSON(e))
        : [],
  ...
  fromJSON(object: any): BTCCheckpointInfo {
    return {
      ...
      bestSubmissionBtcBlockHash: isSet(object.bestSubmissionBtcBlockHash)
        ...
        ? bytesFromBase64(object.best_submission_btc_block_hash)
        : new Uint8Array(0),
      bestSubmissionTransactions: globalThis.Array.isArray(object?.bestSubmissionTransactions)
        ...
        ? object.best_submission_transactions.map((e: any) => TransactionInfo.fromJSON(e))
        : [],
      bestSubmissionVigilanteAddressList: globalThis.Array.isArray(object?.bestSubmissionVigilanteAddressList)
        ...
        ? object.best_submission_vigilante_address_list.map((e: any) => CheckpointAddresses.fromJSON(e))
        : [],
    };
  },
