  ...
  fromJSON(object: any): QueryBtcCheckpointsInfoResponse {
    return {
      infoList: globalThis.Array.isArray(object?.infoList)
        ...
        : globalThis.Array.isArray(object?.info_list)
        ? object.info_list.map((e: any) => BTCCheckpointInfoResponse.fromJSON(e))
        : [],
  ...
  fromJSON(object: any): BTCCheckpointInfoResponse {
    return {
      ...
      bestSubmissionBtcBlockHeight: isSet(object.bestSubmissionBtcBlockHeight)
        ...
        : isSet(object.best_submission_btc_block_height)
        ? globalThis.Number(object.best_submission_btc_block_height)
        : 0,
      bestSubmissionBtcBlockHash: isSet(object.bestSubmissionBtcBlockHash)
        ? globalThis.String(object.bestSubmissionBtcBlockHash)
        : isSet(object.best_submission_btc_block_hash)
        ? globalThis.String(object.best_submission_btc_block_hash)
        : "",
      bestSubmissionTransactions: globalThis.Array.isArray(object?.bestSubmissionTransactions)
        ...
        : globalThis.Array.isArray(object?.best_submission_transactions)
        ? object.best_submission_transactions.map((e: any) => TransactionInfoResponse.fromJSON(e))
        : [],
      bestSubmissionVigilanteAddressList: globalThis.Array.isArray(object?.bestSubmissionVigilanteAddressList)
        ...
        : globalThis.Array.isArray(object?.best_submission_vigilante_address_list)
        ? object.best_submission_vigilante_address_list.map((e: any) => CheckpointAddressesResponse.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): SubmissionKeyResponse {
    return {
      firstTxBlockHash: isSet(object.firstTxBlockHash)
        ...
        : isSet(object.first_tx_block_hash)
        ? globalThis.String(object.first_tx_block_hash)
        : "",
      firstTxIndex: isSet(object.firstTxIndex)
        ? globalThis.Number(object.firstTxIndex)
        : isSet(object.first_tx_index)
        ? globalThis.Number(object.first_tx_index)
        : 0,
      secondTxBlockHash: isSet(object.secondTxBlockHash)
        ? globalThis.String(object.secondTxBlockHash)
        : isSet(object.second_tx_block_hash)
        ? globalThis.String(object.second_tx_block_hash)
        : "",
      secondTxIndex: isSet(object.secondTxIndex)
        ? globalThis.Number(object.secondTxIndex)
        : isSet(object.second_tx_index)
        ? globalThis.Number(object.second_tx_index)
        : 0,
    };
  },
