  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      lastFinalizedEpochNumber: isSet(object.lastFinalizedEpochNumber)
        ...
        : isSet(object.last_finalized_epoch_number)
        ? globalThis.Number(object.last_finalized_epoch_number)
        : 0,
...
export const SubmissionEntry: MessageFns<SubmissionEntry> = {
  ...
  fromJSON(object: any): SubmissionEntry {
    return {
      submissionKey: isSet(object.submissionKey)
        ? SubmissionKey.fromJSON(object.submissionKey)
        : isSet(object.submission_key)
        ? SubmissionKey.fromJSON(object.submission_key)
        : undefined,
