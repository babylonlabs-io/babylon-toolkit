  ...
  fromJSON(object: any): QueuedMessage {
    return {
      ...
      msgCancelUnbondingDelegation: isSet(object.msgCancelUnbondingDelegation)
        ...
        : isSet(object.msg_cancel_unbonding_delegation)
        ? MsgCancelUnbondingDelegation.fromJSON(object.msg_cancel_unbonding_delegation)
        : undefined,
      msgEditValidator: isSet(object.msgEditValidator)
        ? MsgEditValidator.fromJSON(object.msgEditValidator)
        : isSet(object.msg_edit_validator)
        ? MsgEditValidator.fromJSON(object.msg_edit_validator)
        : undefined,
      msgUpdateParams: isSet(object.msgUpdateParams)
        ? MsgUpdateParams.fromJSON(object.msgUpdateParams)
        : isSet(object.msg_update_params)
        ? MsgUpdateParams.fromJSON(object.msg_update_params)
        : undefined,
    };
  },
...
export const ValidatorLifecycle: MessageFns<ValidatorLifecycle> = {
  ...
  fromJSON(object: any): ValidatorLifecycle {
    return {
      valAddr: isSet(object.valAddr)
        ? globalThis.String(object.valAddr)
        : isSet(object.val_addr)
        ? globalThis.String(object.val_addr)
        : "",
      valLife: globalThis.Array.isArray(object?.valLife)
        ? object.valLife.map((e: any) => ValStateUpdate.fromJSON(e))
        : globalThis.Array.isArray(object?.val_life)
        ? object.val_life.map((e: any) => ValStateUpdate.fromJSON(e))
        : [],
    };
  },
...
export const DelegationLifecycle: MessageFns<DelegationLifecycle> = {
  ...
  fromJSON(object: any): DelegationLifecycle {
    return {
      delAddr: isSet(object.delAddr)
        ? globalThis.String(object.delAddr)
        : isSet(object.del_addr)
        ? globalThis.String(object.del_addr)
        : "",
      delLife: globalThis.Array.isArray(object?.delLife)
        ? object.delLife.map((e: any) => DelegationStateUpdate.fromJSON(e))
        : globalThis.Array.isArray(object?.del_life)
        ? object.del_life.map((e: any) => DelegationStateUpdate.fromJSON(e))
        : [],
    };
  },
