  ...
  fromJSON(object: any): GenesisState {
    return {
      genesisKeys: globalThis.Array.isArray(object?.genesisKeys)
        ...
        : globalThis.Array.isArray(object?.genesis_keys)
        ? object.genesis_keys.map((e: any) => GenesisKey.fromJSON(e))
        : [],
      validatorSets: globalThis.Array.isArray(object?.validatorSets)
        ? object.validatorSets.map((e: any) => ValidatorSetEntry.fromJSON(e))
        : globalThis.Array.isArray(object?.validator_sets)
        ? object.validator_sets.map((e: any) => ValidatorSetEntry.fromJSON(e))
        : [],
      checkpoints: globalThis.Array.isArray(object?.checkpoints)
        ? object.checkpoints.map((e: any) => RawCheckpointWithMeta.fromJSON(e))
        : [],
      lastFinalizedEpoch: isSet(object.lastFinalizedEpoch)
        ? globalThis.Number(object.lastFinalizedEpoch)
        : isSet(object.last_finalized_epoch)
        ? globalThis.Number(object.last_finalized_epoch)
        : 0,
    };
  },
  ...
  fromJSON(object: any): GenesisKey {
    return {
      validatorAddress: isSet(object.validatorAddress)
        ...
        : "",
      blsKey: isSet(object.blsKey)
        ? BlsKey.fromJSON(object.blsKey)
        : isSet(object.bls_key)
        ? BlsKey.fromJSON(object.bls_key)
        : undefined,
      valPubkey: isSet(object.valPubkey)
        ? PubKey.fromJSON(object.valPubkey)
        : isSet(object.val_pubkey)
        ? PubKey.fromJSON(object.val_pubkey)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): ValidatorSetEntry {
    return {
      ...
      validatorSet: isSet(object.validatorSet)
        ? ValidatorWithBlsKeySet.fromJSON(object.validatorSet)
        : isSet(object.validator_set)
        ? ValidatorWithBlsKeySet.fromJSON(object.validator_set)
        : undefined,
    };
  },
