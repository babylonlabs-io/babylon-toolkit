  ...
  fromJSON(object: any): ProofOfPossession {
    return {
      ed25519Sig: isSet(object.ed25519Sig)
        ...
        ? bytesFromBase64(object.ed25519_sig)
        : new Uint8Array(0),
  ...
  fromJSON(object: any): ValidatorWithBlsKeySet {
    return {
      valSet: globalThis.Array.isArray(object?.valSet)
        ...
        : globalThis.Array.isArray(object?.val_set)
        ? object.val_set.map((e: any) => ValidatorWithBlsKey.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): ValidatorWithBlsKey {
    return {
      ...
      blsPubKey: isSet(object.blsPubKey)
        ...
        : isSet(object.bls_pub_key)
        ? bytesFromBase64(object.bls_pub_key)
        : new Uint8Array(0),
