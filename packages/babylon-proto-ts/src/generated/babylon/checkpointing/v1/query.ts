  ...
  fromJSON(object: any): QueryRawCheckpointListResponse {
    return {
      rawCheckpoints: globalThis.Array.isArray(object?.rawCheckpoints)
        ...
        : globalThis.Array.isArray(object?.raw_checkpoints)
        ? object.raw_checkpoints.map((e: any) => RawCheckpointWithMetaResponse.fromJSON(e))
        : [],
  ...
  fromJSON(object: any): QueryRawCheckpointResponse {
    return {
      rawCheckpoint: isSet(object.rawCheckpoint)
        ...
        ? RawCheckpointWithMetaResponse.fromJSON(object.raw_checkpoint)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): BlsPublicKeyListResponse {
    return {
      ...
      blsPubKeyHex: isSet(object.blsPubKeyHex)
        ...
        : isSet(object.bls_pub_key_hex)
        ? globalThis.String(object.bls_pub_key_hex)
        : "",
  ...
  fromJSON(object: any): QueryBlsPublicKeyListResponse {
    return {
      validatorWithBlsKeys: globalThis.Array.isArray(object?.validatorWithBlsKeys)
        ...
        : globalThis.Array.isArray(object?.validator_with_bls_keys)
        ? object.validator_with_bls_keys.map((e: any) => BlsPublicKeyListResponse.fromJSON(e))
        : [],
      pagination: isSet(object.pagination) ? PageResponse.fromJSON(object.pagination) : undefined,
    };
  },
  ...
  fromJSON(object: any): QueryRecentEpochStatusCountRequest {
    return {
      epochCount: isSet(object.epochCount)
        ...
        : isSet(object.epoch_count)
        ? globalThis.Number(object.epoch_count)
        : 0,
    };
  },
...
export const QueryRecentEpochStatusCountResponse: MessageFns<QueryRecentEpochStatusCountResponse> = {
  encode(message: QueryRecentEpochStatusCountResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.statusCount).forEach(([key, value]: [string, number]) => {
  ...
  fromJSON(object: any): QueryRecentEpochStatusCountResponse {
    return {
      tipEpoch: isSet(object.tipEpoch)
        ...
        : isSet(object.tip_epoch)
        ? globalThis.Number(object.tip_epoch)
        : 0,
      epochCount: isSet(object.epochCount)
        ? globalThis.Number(object.epochCount)
        : isSet(object.epoch_count)
      ...
      statusCount: isObject(object.statusCount)
        ? (globalThis.Object.entries(object.statusCount) as [string, any][]).reduce(
        ...
        : isObject(object.status_count)
        ? (globalThis.Object.entries(object.status_count) as [string, any][]).reduce(
          (acc: { [key: string]: number }, [key, value]: [string, any]) => {
            acc[key] = globalThis.Number(value);
            return acc;
          },
  ...
  toJSON(message: QueryRecentEpochStatusCountResponse): unknown {
    ...
    if (message.statusCount) {
      const entries = globalThis.Object.entries(message.statusCount) as [string, number][];
      if (entries.length > 0) {
        obj.statusCount = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryRecentEpochStatusCountResponse>, I>>(
    ...
    message.epochCount = object.epochCount ?? 0;
    message.statusCount = (globalThis.Object.entries(object.statusCount ?? {}) as [string, number][]).reduce(
  ...
  fromJSON(object: any): QueryLastCheckpointWithStatusResponse {
    return {
      rawCheckpoint: isSet(object.rawCheckpoint)
        ...
        : isSet(object.raw_checkpoint)
        ? RawCheckpointResponse.fromJSON(object.raw_checkpoint)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): RawCheckpointResponse {
    return {
      ...
      blockHashHex: isSet(object.blockHashHex)
        ...
        : isSet(object.block_hash_hex)
        ? globalThis.String(object.block_hash_hex)
        : "",
      ...
      blsMultiSig: isSet(object.blsMultiSig)
        ...
        : isSet(object.bls_multi_sig)
        ? bytesFromBase64(object.bls_multi_sig)
        : new Uint8Array(0),
    };
  },
  ...
  fromJSON(object: any): RawCheckpointWithMetaResponse {
    return {
      ...
      blsAggrPk: isSet(object.blsAggrPk)
        ...
        : isSet(object.bls_aggr_pk)
        ? bytesFromBase64(object.bls_aggr_pk)
        : new Uint8Array(0),
      powerSum: isSet(object.powerSum)
        ? globalThis.Number(object.powerSum)
        : isSet(object.power_sum)
        ? globalThis.Number(object.power_sum)
        : 0,
