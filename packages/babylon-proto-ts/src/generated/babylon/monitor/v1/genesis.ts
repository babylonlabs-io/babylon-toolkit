  ...
  fromJSON(object: any): GenesisState {
    return {
      epochEndRecords: globalThis.Array.isArray(object?.epochEndRecords)
        ...
        : globalThis.Array.isArray(object?.epoch_end_records)
        ? object.epoch_end_records.map((e: any) => EpochEndLightClient.fromJSON(e))
        : [],
      checkpointsReported: globalThis.Array.isArray(object?.checkpointsReported)
        ...
        : globalThis.Array.isArray(object?.checkpoints_reported)
        ? object.checkpoints_reported.map((e: any) => CheckpointReportedLightClient.fromJSON(e))
        : [],
    };
  },
  ...
  fromJSON(object: any): EpochEndLightClient {
    return {
      ...
      btcLightClientHeight: isSet(object.btcLightClientHeight)
        ...
        : isSet(object.btc_light_client_height)
        ? globalThis.Number(object.btc_light_client_height)
        : 0,
    };
  },
  ...
  fromJSON(object: any): CheckpointReportedLightClient {
    return {
      ckptHash: isSet(object.ckptHash)
        ...
        : isSet(object.ckpt_hash)
        ? globalThis.String(object.ckpt_hash)
        : "",
      btcLightClientHeight: isSet(object.btcLightClientHeight)
        ? globalThis.Number(object.btcLightClientHeight)
        : isSet(object.btc_light_client_height)
